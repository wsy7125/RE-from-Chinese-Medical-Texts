...
def predict_infer(conf_dict, data_reader, predict_data_path,
    ...
    test_batch_reader = paddle.batch(
        paddle.reader.buffered(
            data_reader.get_predict_reader(predict_data_path, need_input=True, need_label=False), size=8192),
...
def main(conf_dict, model_path, predict_data_path,
    ...
    predict_infer(conf_dict, data_generator, predict_data_path, predict_result_path, model_path)
