...
class DataReader(object):
    ...
    def __init__(self,
        ...
        for input_dict in [wordemb_dict_path, postag_dict_path, label_dict_path,
                           train_data_list_path, test_data_list_path]:
    ...
    def _cal_mark_slot(self, spo_list, sentence, p, token_idx_list):
        ...
        for spo in spo_list:
            ...
            sub = spo['subject']
            obj = spo['object']
            s_idx_list = self._cal_item_pos(self._add_item_offset(sub, sentence), token_idx_list)
            o_idx_list = self._cal_item_pos(self._add_item_offset(obj, sentence), token_idx_list)
        ...
        def reader():
            ...
            if os.path.isdir(data_path):
                ...
                for data_file in input_files:
                    ...
                    for line in open(data_file_path.strip(), encoding='utf-8'):
