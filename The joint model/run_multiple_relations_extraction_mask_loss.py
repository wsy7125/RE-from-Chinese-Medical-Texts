...
class SKE_2019_Subject_Relation_Object_extraction_Processor(DataProcessor):
    ...
    def _raw_token_labels(self):
        return ['疾病', '其他', '其他治疗', '手术治疗', '检查', '流行病学', '症状', '社会学', '药物', '部位', '预后']
    ...
    def get_predicate_labels(self):
        "N --> no predicate"
        return ["N", '预防', '阶段', '就诊科室', '同义词', '辅助治疗', '化疗', '放射治疗', '同义词', '手术治疗', '同义词', '实验室检查', '影像学检查', '辅助检查', '组织学检查',
                '同义词', '内窥镜检查', '筛查', '多发群体', '发病率', '发病年龄', '多发地区', '发病性别倾向', '死亡率', '多发季节', '传播途径', '同义词', '同义词', '并发症', '病理分型',
                '相关（导致）', '鉴别诊断', '相关（转化）', '相关（症状）', '临床表现', '治疗后症状', '侵及周围组织转移的症状', '同义词', '病因', '高危因素', '风险评估因素', '病史', '遗传因素', '同义词', '发病机制', '病理生理',
                '药物治疗', '同义词', '发病部位', '转移部位', '外侵部位', '同义词', '预后状况', '预后生存率']
